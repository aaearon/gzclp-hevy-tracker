...
const VISUAL_CONFIGS: Record<VisualState, VisualConfig> = {
  progress: {
    ...
    resultTextColor: 'text-green-800',
    label: 'SUCCESS',
  },
  repeat: {
    borderColor: 'border-blue-500',
    bgColor: 'bg-blue-50',
    resultBgColor: 'bg-blue-100',
    resultTextColor: 'text-blue-800',
    label: 'SUCCESS',
  },
  stage_change: {
    borderColor: 'border-amber-500',
    bgColor: 'bg-amber-50',
    resultBgColor: 'bg-amber-100',
    resultTextColor: 'text-amber-800',
    label: 'FAIL',
  },
  deload: {
    ...
    resultTextColor: 'text-red-800',
    label: 'FAIL',
  },
  no_data: {
    borderColor: 'border-gray-300',
    bgColor: 'bg-gray-50',
    resultBgColor: 'bg-gray-100',
    ...
    >
      ...
      <div className="text-sm text-gray-600 mb-3">
        ...
        {hasData && performance ? (
          ...
          <span className="italic text-gray-400">No workout data</span>
        )}
      </div>
      ...
      {hasData && performance && (
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            {suggestion?.reason && <span className="text-gray-700">{suggestion.reason}</span>}
          </div>
        </div>
      )}
      ...
      {/* Next target section */}
      <div
        className={`rounded-md border ${config.borderColor} bg-white p-3`}
        role="group"
      ...
      >
        <div className="flex flex-wrap items-center gap-3">
          ...
          {suggestion?.reason && (
            <span id={`${inputId}-explanation`} className="text-sm text-gray-600">
